...
+	coreAPI := coreapi.NewCoreImpl(database, eventBus, contentSvc, menuSvc, mediaResolver, func() *cms.PluginManager { return pluginManager }, nodeTypeSvc, app, secretsSvc)
...
PATCH
patch cmd/squilla/main.go main.patch
